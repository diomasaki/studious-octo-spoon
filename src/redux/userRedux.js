...
const userSlice = createSlice({
  ...
  reducers: {
    ...
    updateCredentialsSuccess4: (state, action) => {
      state.isFetching = false;
      state.confirmedPassword = null;
