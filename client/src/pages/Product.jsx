...
const Product = () => {
  ...
  const usr = useSelector((state) =>
    state.user.currentUser ? state.user.currentUser.username : ""
  );
  ...
  const comments = useSelector(
    (state) => state.commentsratings.commentsratings
  );
  ...
  const handleClick2 = (color, size) => {
    dispatch(addToWishlist({ ...product, quantity, color, size }));
  };
  ...
  const handleClick3 = (x, y, z) => {
    dispatch(removeFromWishlist({ x, y, z }));
  };
    ...
    <Container>
      ...
      <Wrapper>
        ...
        <InfoContainer>
          ...
          <AddContainer>
            <AmountContainer>
              <Remove onClick={() => handleDecrement("dec")} />
            ...
            <div style={{ display: "flex", alignItems: "center" }}>
              {product.inStock ? (
                checkIfExist() ? (
                  ...
                  <Button
                    onClick={() => handleClick(product.color, product.size)}
                  >
                    ADD TO CART
                  </Button>
                )
              ...
              <Duo style={{ marginTop: "12px" }}>
                ...
                >
                  ...
                  <DoneIcon
                    ...
                    onClick={() => handleEdit2(editId, editText, editRating)}
                  />
                </div>
              </Duo>
            )}
