...
import { removeProduct, updateProduct, clearCart, updateProduct2 } from "../redux/cartRedux";
...
const Cart = () => {
  ...
  const handleQuantity2 = (mark, x) => {
    if (mark === "+") {
      dispatch(updateProduct2({ mark, x }));
    } else {
      dispatch(updateProduct2({ mark, x }));
    }
  };
        ...
        <Bottom>
              ...
              <Product key={product._id}>
                ...
                <PriceDetail>
                  <ProductAmountContainer>
                    <Add onClick={() => handleQuantity2("+", product._id)} />
          ...
          <Summary>
            ...
            {cart.total !== 0 ? (
              ...
              <Button style={{ marginBottom: "20px" }}>EMPTY BAG</Button>
            )}
            {cart.total !== 0 ? (
