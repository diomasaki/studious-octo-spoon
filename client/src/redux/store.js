...
const rootReducer = combineReducers({ user: userReducer, order: orderReducer, cart: cartReducer, wishlist: wishlistReducer, commentsratings: commentsratingsReducer });
