      ...
      <div className="productBottom">
        <div className="productForm">
          <div className="productFormLeft">
            ...
            <Duo>
            <Input type="text" placeholder={produc.title} name="title" onChange={(e) => setName(e.target.value)}/>
            </Duo>
            <Duo>
            <Input type="text" placeholder={produc.desc} name="desc" onChange={(e) => setDesc(e.target.value)}/>
            </Duo>
            <Duo>
            <Input type="text" placeholder={produc.price} name="price" onChange={(e) => setPrice(e.target.value)} />
            </Duo>
            <Duo>
            ...
            <Duo>
            <Input type="text" placeholder={produc.color} onChange={handleClr} required />
            </Duo>
            <Duo>
            <Input type="text" placeholder={produc.size}  onChange={handleSz} required />
            </Duo>
            <Duo>
